...
namespace DA_Assets.FCU
{
    ...
    public class SpriteDuplicateRemover : FcuBase
    {
        ...
        internal async Task RemoveDuplicates(List<FObject> fobjects, SpriteDuplicateFinderRequest request, CancellationToken token)
        {
        ...
        internal async Task ApplyDuplicateSelection(List<FObject> fobjects, List<List<SpriteUsageFinder.UsedSprite>> processedGroups, CancellationToken token)
        {
        ...
        private void RedrawReplacedSprite(FObject fobject, string newPath)
        {
            if (newPath.IsEmpty())
                return;
