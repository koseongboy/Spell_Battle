...
namespace DA_Assets.FCU.Extensions
{
    public static class TextExtensions
    {
        ...
        /// <summary>
        /// Canonical weight → style-name buckets per OpenType usWeightClass.
        ...
        /// <summary>
        /// Weight keywords ordered specific-first: compound forms (extralight, semibold, …)
        /// appear before their base substrings (light, bold, …) so matching short-circuits
        /// on the most specific keyword. Keywords are stored lowercase/no-separator and
        /// are expected to be matched against text that went through <see cref="FormatFontName(string)"/>.
        /// The optional <see cref="FontWeightKeyword.Allow"/> guard is consulted by
        /// normalizers that know the caller's original weight; name-scan callers ignore it.
        /// </summary>
        ...
        /// <summary>
        /// Converts numeric font weight (1–1099) to a descriptive style name,
        ...
        public static List<FontMetadata> GetAllFontMetadata(this FObject fobject)
        {
...
#if UNITEXT
        public static LightSide.HorizontalAlignment GetUniTextHAlign(this FObject fobject)
        {
            switch (fobject.Style.TextAlignHorizontal)
            {
                ...
                case TextAlignHorizontal.JUSTIFIED:
                    return LightSide.HorizontalAlignment.Left; // UniText has no Justified; fallback to Left
                default:
                    return LightSide.HorizontalAlignment.Left;
            }
        }

        public static LightSide.VerticalAlignment GetUniTextVAlign(this FObject fobject)
        {
