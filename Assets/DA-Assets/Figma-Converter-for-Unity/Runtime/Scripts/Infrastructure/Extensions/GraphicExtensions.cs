...
namespace DA_Assets.FCU.Extensions
{
    public static class GraphicExtensions
    {
        ...
        /// <summary>
        /// Compares Color32 by RGB only, ignoring alpha.
        /// </summary>
        ...
        private static void IsSingleColorRecursive(FObject fobject, List<bool> flags, HashSet<Color32> rgbValues)
        {
            ...
            if (fobject.Effects.IsEmpty() == false)
            {
                foreach (Effect effect in fobject.Effects)
                {
                    ...
                    switch (effect.Type)
                    {
                        // Blur effects have no color impact on the element.
                        case EffectType.LAYER_BLUR:
                        case EffectType.BACKGROUND_BLUR:
                            break;

                        // Shadows have their own color — it must match the fill color for single-color.
        ...
        public static bool IsRotationInvariantSolidCircle(this FObject fobject)
        {
        ...
        public static bool IsScaleInvariantSolidFillCircle(this FObject fobject)
        {
            if (!fobject.IsCircle() || fobject.IsArcDataFilled())
                return false;
        ...
        public static bool IsScaleInvariantAutoSlice9CircleSource(this FObject fobject)
        {
        ...
        public static bool IsScaleInvariantAutoSlice9(this FObject fobject)
        {
        ...
        public static bool HasOnlySolidVisibleFillAndStroke(this FObject fobject)
        {
            bool hasSolidPaint = false;
        ...
        public static bool CanMinimizeAutoSlice9Sprite(this FObject fobject)
        {
            return fobject.Data.ManualWhiteColor || fobject.HasOnlySolidVisibleFillAndStroke();
        }

        public static bool IsDrawableSolidOverlayContainer(this FObject fobject)
        {
            return fobject.TryGetDrawableSolidOverlayPaint(out _, out _);
        }

        public static bool TryGetDrawableSolidOverlayPaint(this FObject fobject, out Paint paint, out Color color)
        {
            paint = default;
            color = default;
        ...
        private static bool HasUniformAutoSlice9Corners(FObject fobject)
        {
        ...
        public static bool TryGetAutoSlice9SourceBorder(this FObject fobject, out Vector4 border)
        {
            border = default;
        ...
        public static bool TryGetVectorRoundedRectSourceBorder(this FObject fobject, out Vector4 border)
        {
            border = default;
        ...
        private static bool HasVisibleSolidFill(FObject fobject)
        {
            if (fobject.Fills.IsEmpty())
                return false;
        ...
        private static bool HasAsymmetricShadow(FObject fobject)
        {
        ...
        private static float GetMaxAutoSliceEffectExtent(FObject fobject)
        {
            if (fobject.Effects.IsEmpty())
                return 0f;
