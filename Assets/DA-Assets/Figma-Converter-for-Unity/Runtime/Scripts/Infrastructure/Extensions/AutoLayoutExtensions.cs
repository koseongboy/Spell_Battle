...
namespace DA_Assets.FCU.Extensions
{
    ...
    {
        public static bool ShouldReverseAutoLayoutDrawOrder(this FObject fobject)
        {
        ...
        public static RectOffsetCustom AdjustPadding(this RectOffsetCustom padding, FObject fobject, FRect parentRect, IReadOnlyList<FObject> children)
        {
        ...
        private static Vector2[] GetAutoLayoutChildSizes(FRect parentRect, IReadOnlyList<FObject> children)
        {
        ...
        public static bool ShouldUseChildForAutoLayoutSize(FRect parentRect, FObject child, IReadOnlyList<FObject> siblings)
        {
        ...
        private static bool IsBackgroundLikeLayoutChild(FRect parentRect, FObject child, IReadOnlyList<FObject> siblings)
        {
        ...
        public static float GetHorSpacing(this FObject fobject)
        {
            ...
            if (fobject.PrimaryAxisAlignItems == PrimaryAxisAlignItem.SPACE_BETWEEN)
            {
                ...
                {
                    state = 3;
                    List<FObject> layoutChildren = fobject.Children
                    ...
                    foreach (FObject child in layoutChildren)
                    {
        ...
        private static bool TryGetHorSpacingFromChildBounds(FObject fobject, out float spacing)
        {
            spacing = 0f;
            ...
            FObject first = layoutChildren[0];
            FObject second = layoutChildren[1];
        ...
        private static bool TryGetVertSpacingFromChildBounds(FObject fobject, out float spacing)
        {
            spacing = 0f;
