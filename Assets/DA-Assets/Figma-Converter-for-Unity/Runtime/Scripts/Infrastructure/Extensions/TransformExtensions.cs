...
namespace DA_Assets.FCU.Extensions
{
    public static class TransformExtensions
    {
        ...
        public static bool HasFigmaScaleConstraint(this FObject fobject)
        {
            return fobject.Constraints.Horizontal == SCALE_CONSTRAINT ||
                   fobject.Constraints.Vertical == SCALE_CONSTRAINT;
        }

        public static bool TryGetFigmaScaleAnchors(this FObject fobject, out Vector2 anchorMin, out Vector2 anchorMax)
        {
            anchorMin = default;
            anchorMax = default;
        ...
        public static void ApplyFigmaScaleAnchors(this RectTransform rectTransform, FObject fobject)
        {
        ...
        private static bool TryGetSpriteFRectScaleAnchors(FObject fobject, out Vector2 anchorMin, out Vector2 anchorMax)
        {
            anchorMin = default;
            anchorMax = default;
        ...
        private static bool TryGetFigmaLocalPosition(FObject fobject, out Vector2 localPosition)
        {
