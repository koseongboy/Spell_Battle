...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    ...
    public class ImageDrawer : FcuBase
    {
        ...
        private void ApplyAutoSlice9PixelsPerUnit(FObject fobject, Image img)
        {
        ...
        public void AddDAOutline(FObject fobject)
        {
        ...
        public void ClearBakedSpriteOverlays(FObject fobject)
        {
            GameObject gameObject = fobject.Data.GameObject;
            if (gameObject == null)
                return;
