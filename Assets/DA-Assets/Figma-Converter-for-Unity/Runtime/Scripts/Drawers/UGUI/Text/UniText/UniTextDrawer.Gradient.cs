...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    public partial class UniTextDrawer
    {
        ...
        private static string TryBuildDefaultGradientParameter(FObject fobject, Style defaultStyle)
        {
        ...
        private static string TryBuildGradientParameter(Paint paint)
        {
            ...
            string shape = GetGradientShape(paint.Type);
            float angle = GetGradientAngle(paint);
            string gradientName = GenerateGradientName(paint);
