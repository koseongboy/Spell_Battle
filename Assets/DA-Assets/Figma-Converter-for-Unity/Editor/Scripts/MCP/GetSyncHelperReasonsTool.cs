...
namespace DA_Assets.FCU.MCP
{
    ...
    {
        public GetSyncHelperReasonsTool(FigmaConverterUnity monoBeh, McpToolSO toolSO) : base(monoBeh, toolSO)
        {
        }
        ...
        private SyncHelperReasonsResult CreateResult(FigmaConverterUnity fcu, Dictionary<string, object> args)
        {
            if (!fcu.IsDebug())
            {
