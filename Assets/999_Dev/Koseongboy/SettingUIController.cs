...
public class SettingUIController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (SoundManager.Instance != null && SoundManager.Instance.isRecording)
        {
            gaugeBar.fillAmount = SoundManager.Instance.GetMicVolumeGauge();
        }
    }
    ...
    private void OnCancelButtonClicked()
    {
        ...
        SoundManager.Instance.micVolumeMultiplier = originalMicVol;
    ...
    private async void OnRecordDefaultVoiceClicked()
    {
        ...
        {
            // 2. 녹음 종료
            byte[] myDefaultWav = SoundManager.Instance.StopRecording();
