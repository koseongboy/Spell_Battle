...
{
    [Header("Transforms (Layout Groups)")]
    public Transform centerCardContent;
    public Transform leftDeckListContent;
    public Transform rightCardInDeckContent;

    [Header("Prefabs")]
    public UI_Card uiCardPrefab;
    ...
    public Button[] costFilterButtons;     
    ...
    public void BindCostFilter(int cost, Action onClick) 
        => costFilterButtons[cost].onClick.AddListener(() => onClick());
    }
}
